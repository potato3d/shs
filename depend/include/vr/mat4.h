...
{
	void _vr_mat4_getRotation( const mat4<real>& r, quat<real>& q );
	_vr_mat4_getRotation( *this, q );
}
...
{
	void _vr_mat4_set( mat4<real>& r, const quat<real>& q_in );
	_vr_mat4_set( *this, q_in );
}
...
{
	void _vr_mat4_makeIdentity( vr::mat4<real>& r );
	_vr_mat4_makeIdentity( *this );
}

template<typename real>
void mat4<real>::makeScale( const vec3<real>& scale )
{
	void _vr_mat4_makeScale( vr::mat4<real>& r, const vr::vec3<real>& scale );
	_vr_mat4_makeScale( *this, scale );
}

template<typename real>
void mat4<real>::makeScale( real x, real y, real z )
{
	void _vr_mat4_makeScale( vr::mat4<real>& r, real x, real y, real z );
	_vr_mat4_makeScale( *this, x, y, z );
}

template<typename real>
void mat4<real>::makeTranslation( const vec3<real>& trans )
{
	void _vr_mat4_makeTranslation( vr::mat4<real>& r, const vr::vec3<real>& trans );
	_vr_mat4_makeTranslation( *this, trans );
}

template<typename real>
void mat4<real>::makeTranslation( real x, real y, real z )
{
	void _vr_mat4_makeTranslation( vr::mat4<real>& r, real x, real y, real z );
	_vr_mat4_makeTranslation( *this, x, y, z );
}

template<typename real>
void mat4<real>::makeRotation( const vec3<real>& from, const vec3<real>& to )
{
	void _vr_mat4_makeRotation( vr::mat4<real>& r, const vr::vec3<real>& from, const vr::vec3<real>& to );
	_vr_mat4_makeRotation( *this, from, to );
}

template<typename real>
void mat4<real>::makeRotation( real radians, const vec3<real>& axis )
{
	void _vr_mat4_makeRotation( vr::mat4<real>& r, real radians, const vr::vec3<real>& axis );
	_vr_mat4_makeRotation( *this, radians, axis );
}
...
void mat4<real>::makeRotation( real angle1, const vec3<real>& axis1,  
									 ...
									 real angle3, const vec3<real>& axis3 )
{
	void _vr_mat4_makeRotation( vr::mat4<real>& r, real angle1, const vr::vec3<real>& axis1,  
								   real angle2, const vr::vec3<real>& axis2,  
								   real angle3, const vr::vec3<real>& axis3 );
	_vr_mat4_makeRotation( *this, angle1, axis1, angle2, axis2, angle3, axis3 );
}
...
{
	void _vr_mat4_makeOrtho( vr::mat4<real>& r, real left, real right, real bottom, real top, real zNear, real zFar );
	_vr_mat4_makeOrtho( *this, left, right, bottom, top, zNear, zFar );
}

template<typename real>
bool mat4<real>::getOrtho( real& left, real& right, real& bottom, real& top, real& zNear, real& zFar ) const
{
	bool _vr_mat4_getOrtho( const vr::mat4<real>& r, real& left, real& right, real& bottom, real& top, real& zNear, real& zFar );
	return _vr_mat4_getOrtho( *this, left, right, bottom, top, zNear, zFar );
}
...
{
	void _vr_mat4_makeFrustum( vr::mat4<real>& r, real left, real right, real bottom, real top, real zNear, real zFar );
	_vr_mat4_makeFrustum( *this, left, right, bottom, top, zNear, zFar );
}

template<typename real>
bool mat4<real>::getFrustum( real& left, real& right, real& bottom, real& top, real& zNear, real& zFar ) const
{
	bool _vr_mat4_getFrustum( const vr::mat4<real>& r, real& left, real& right, real& bottom, real& top, real& zNear, real& zFar );
	return _vr_mat4_getFrustum( *this, left, right, bottom, top, zNear, zFar );
}

template<typename real>
void mat4<real>::makePerspective( real fovy, real aspectRatio, real zNear, real zFar )
{
	void _vr_mat4_makePerspective( vr::mat4<real>& r, real fovy, real aspectRatio, real zNear, real zFar );
	_vr_mat4_makePerspective( *this, fovy, aspectRatio, zNear, zFar );
}

template<typename real>
bool mat4<real>::getPerspective( real& fovy, real& aspectRatio, real& zNear, real& zFar ) const
{
	bool _vr_mat4_getPerspective( const vr::mat4<real>& r, real& fovy, real& aspectRatio, real& zNear, real& zFar );
	return _vr_mat4_getPerspective( *this, fovy, aspectRatio, zNear, zFar );
}

template<typename real>
void mat4<real>::makeLookAt( const vec3<real>& eye, const vec3<real>& center, const vec3<real>& up )
{
	void _vr_mat4_makeLookAt( vr::mat4<real>& r, const vr::vec3<real>& eye, const vr::vec3<real>& center, const vr::vec3<real>& up );
	_vr_mat4_makeLookAt( *this, eye, center, up );
}

template<typename real>
void mat4<real>::getLookAt( vec3<real>& eye, vec3<real>& center, vec3<real>& up, real lookDistance ) const
{
	void _vr_mat4_getLookAt( const vr::mat4<real>& r, vr::vec3<real>& eye, vr::vec3<real>& center, vr::vec3<real>& up, real lookDistance );
	_vr_mat4_getLookAt( *this, eye, center, up, lookDistance );
}
...
{
	void _vr_mat4_transpose( vr::mat4<real>& r );
	_vr_mat4_transpose( *this );
}

template<typename real>
void mat4<real>::invert()
{
	void _vr_mat4_invert( vr::mat4<real>& r );
	_vr_mat4_invert( *this );
}

template<typename real>
void mat4<real>::product( const mat4<real>& a, const mat4<real>& b )
{
	void _vr_mat4_product( vr::mat4<real>& r, const vr::mat4<real>& a, const vr::mat4<real>& b );
	_vr_mat4_product( *this, a, b );
}
